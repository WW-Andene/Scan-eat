...
class BackupRepository @Inject constructor(
    ...
    private val savedSearchFilterRepo: fr.scanneat.data.repository.foodsearch.SavedSearchFilterRepository,
    ...
    suspend fun exportToJson(passphrase: String? = null): String {
        ...
        val bundle = BackupBundle(
            ...
            settings = SettingsBackup(
                ...
                animatedBackground = prefs.animatedBackground.first(),
                biolismAdvancedView = prefs.biolismAdvancedView.first(),
                activityBestStreak = prefs.activityBestStreak.first(),
                budgetWeeklyEuros = prefs.budgetWeeklyEuros.first(),
                budgetPerMealEuros = prefs.budgetPerMealEuros.first(),
            ),
            ...
            savedSearchFilters = savedSearchFilterRepo.exportAll(),
        )
    ...
    suspend fun importFromJson(json: String, passphrase: String? = null): Result<BackupSummary> = ioCatching {
        ...
        savedSearchFilterRepo.importAll(bundle.savedSearchFilters)
