...
internal val FOOD_DB_GRAINS_AND_PROTEINS: List<FoodEntry> = listOf(
    ...
    FoodEntry("pain complet",    240.0, 9.0, 45.0, 3.0, 6.5, ironMg = 2.5, magnesiumMg = 76.0, aliases = listOf("whole wheat bread")),
    FoodEntry("baguette",        265.0, 8.0, 55.0, 1.0, 2.3),
    FoodEntry("croissant",       406.0, 8.0, 45.0, 21.0, 1.6),
    FoodEntry("avoine",          389.0, 17.0, 66.0, 7.0, 10.6, ironMg = 4.7, magnesiumMg = 138.0, zincMg = 4.0, aliases = listOf("flocons d'avoine", "oats")),
    FoodEntry("quinoa cuit",     120.0, 4.4, 22.0, 1.9, 2.8, ironMg = 1.5, magnesiumMg = 64.0, zincMg = 1.1),

    // Protéines animales
    FoodEntry("poulet rôti",    215.0, 30.0,  0.0, 10.0, 0.0, saltG = 0.2, b12Ug = 0.3, zincMg = 1.0, b6Mg = 0.5),
    FoodEntry("boeuf haché 5%", 130.0, 22.0,  0.0,  5.0, 0.0, saltG = 0.1, ironMg = 2.6, b12Ug = 2.0, zincMg = 4.5, aliases = listOf("steak haché 5%")),
    FoodEntry("boeuf haché 15%",215.0, 20.0,  0.0, 15.0, 0.0, saltG = 0.1, ironMg = 2.7, b12Ug = 2.0, zincMg = 4.5),
    FoodEntry("saumon",         208.0, 20.0,  0.0, 13.0, 0.0, vitDUg = 8.0, b12Ug = 3.2, b6Mg = 0.6, aliases = listOf("salmon")),
    FoodEntry("thon",           130.0, 29.0,  0.0,  1.0, 0.0, vitDUg = 2.3, b12Ug = 2.9, b6Mg = 0.9, aliases = listOf("tuna")),
    ...
    FoodEntry("dinde",          135.0, 29.0,  0.0,  1.5, 0.0, b12Ug = 0.3, zincMg = 1.5, b6Mg = 0.5, aliases = listOf("blanc de dinde", "turkey")),
    FoodEntry("porc",           242.0, 27.0,  0.0, 14.0, 0.0, b12Ug = 0.7, zincMg = 2.0, aliases = listOf("filet de porc", "pork")),
    FoodEntry("agneau",         294.0, 25.0,  0.0, 21.0, 0.0, ironMg = 1.6, b12Ug = 2.3, zincMg = 4.0, aliases = listOf("lamb")),
    FoodEntry("canard",         337.0, 19.0,  0.0, 28.0, 0.0, ironMg = 2.7, aliases = listOf("duck")),
    FoodEntry("crevette",        99.0, 24.0,  0.2,  0.3, 0.0, b12Ug = 1.1, zincMg = 1.3, aliases = listOf("crevettes", "shrimp")),
    FoodEntry("moules",         172.0, 24.0,  7.0,  4.5, 0.0, ironMg = 6.7, b12Ug = 12.0, zincMg = 1.6, aliases = listOf("mussels")),
    ...
    FoodEntry("foie de veau",     140.0, 20.0,  4.0,  4.0, 0.0, ironMg = 6.0, vitDUg = 0.5, b12Ug = 45.0, vitAUg = 9500.0, zincMg = 4.0, b9Ug = 290.0, aliases = listOf("veal liver")),
