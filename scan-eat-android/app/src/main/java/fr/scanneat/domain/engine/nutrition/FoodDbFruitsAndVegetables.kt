...
internal val FOOD_DB_FRUITS_AND_VEGETABLES: List<FoodEntry> = listOf(
    ...
    FoodEntry("pamplemousse",  42.0,  0.8,  11.0,  0.1,  1.6, vitCMg = 31.2, aliases = listOf("grapefruit")),
    FoodEntry("pomelo",        38.0,  0.8,   9.0,  0.1,  1.0, vitCMg = 61.0, aliases = listOf("pomélo")),
