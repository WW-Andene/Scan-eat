...
internal val FOOD_DB_FRUITS_AND_VEGETABLES: List<FoodEntry> = listOf(
    // Fruits
    FoodEntry("pomme",        54.0,  0.3,  12.0,  0.2,  2.4,  sugarsG = 10.3, aliases = listOf("apple")),
    ...
    FoodEntry("banane",       90.0,  1.1,  20.0,  0.3,  2.6,  sugarsG = 15.0, potassiumMg = 358.0, b6Mg = 0.4, aliases = listOf("banana")),
    ...
    FoodEntry("orange",       45.0,  0.9,   9.0,  0.2,  2.2,  sugarsG = 8.0, vitCMg = 53.2, potassiumMg = 181.0, b9Ug = 30.0),
    ...
    FoodEntry("avocat",      160.0,  2.0,   2.0, 15.0,  6.7,  saturatedFatG = 2.1, sugarsG = 0.7, potassiumMg = 485.0, magnesiumMg = 29.0, vitEMg = 2.1, b6Mg = 0.3, b9Ug = 81.0, aliases = listOf("avocado")),
    FoodEntry("kiwi",         61.0,  1.1,  11.0,  0.5,  3.0,  sugarsG = 9.0, vitCMg = 92.7, potassiumMg = 312.0, vitEMg = 1.5, vitKUg = 40.0),
    FoodEntry("raisin",       69.0,  0.7,  16.0,  0.2,  0.9,  sugarsG = 15.5, aliases = listOf("raisins", "grape")),

    // Légumes
    FoodEntry("tomate",       18.0,  0.9,   3.0,  0.2,  1.2,  sugarsG = 2.6, aliases = listOf("tomate cerise", "tomato")),
    FoodEntry("carotte",      36.0,  0.6,   7.0,  0.2,  2.8,  sugarsG = 4.7, vitAUg = 835.0, aliases = listOf("carrot")),
    ...
    FoodEntry("concombre",    12.0,  0.6,   2.0,  0.1,  0.5,  sugarsG = 1.7, aliases = listOf("cucumber")),
    FoodEntry("courgette",    15.0,  1.3,   2.0,  0.1,  1.1,  sugarsG = 2.5, aliases = listOf("zucchini")),
    FoodEntry("poivron",      27.0,  0.9,   5.0,  0.2,  1.9,  sugarsG = 4.2, vitCMg = 120.0, vitAUg = 157.0, potassiumMg = 211.0, aliases = listOf("pepper")),
    FoodEntry("oignon",       34.0,  1.2,   6.0,  0.1,  1.7,  sugarsG = 4.2, aliases = listOf("onion")),
    FoodEntry("salade verte", 15.0,  1.3,   1.5,  0.2,  1.3,  sugarsG = 0.8, aliases = listOf("salade", "laitue", "lettuce")),
    FoodEntry("pomme de terre", 80.0, 2.0, 17.0,  0.1,  1.8,  sugarsG = 0.8, potassiumMg = 425.0, magnesiumMg = 23.0, b6Mg = 0.3, aliases = listOf("patate", "potato")),

    // Fruits (suite)
    FoodEntry("pêche",         39.0,  0.9,   9.0,  0.3,  1.5, sugarsG = 8.0, aliases = listOf("peach")),
    FoodEntry("poire",         57.0,  0.4,  15.0,  0.1,  3.1, sugarsG = 9.8, aliases = listOf("pear")),
    FoodEntry("ananas",        50.0,  0.5,  13.0,  0.1,  1.4, sugarsG = 9.9, aliases = listOf("pineapple")),
    FoodEntry("mangue",        60.0,  0.8,  15.0,  0.4,  1.6, sugarsG = 13.7, aliases = listOf("mango")),
    ...
    FoodEntry("abricot",       48.0,  1.4,  11.0,  0.4,  2.0, sugarsG = 9.2, aliases = listOf("apricot")),
    FoodEntry("prune",         46.0,  0.7,  11.0,  0.3,  1.4, sugarsG = 9.9, aliases = listOf("plum")),
    FoodEntry("pamplemousse",  42.0,  0.8,  11.0,  0.1,  1.6, sugarsG = 6.9, vitCMg = 31.2, aliases = listOf("grapefruit")),
    FoodEntry("pomelo",        38.0,  0.8,   9.0,  0.1,  1.0, sugarsG = 7.3, vitCMg = 61.0, aliases = listOf("pomélo")),
    FoodEntry("citron",        29.0,  1.1,   9.0,  0.3,  2.8, sugarsG = 2.5, vitCMg = 53.0, aliases = listOf("lemon")),
    FoodEntry("clémentine",    47.0,  0.8,  12.0,  0.2,  1.7, sugarsG = 9.2, vitCMg = 48.8, aliases = listOf("mandarine", "clementine")),
    FoodEntry("figue",         74.0,  0.8,  19.0,  0.3,  2.9, sugarsG = 16.3, aliases = listOf("figues", "fig")),
    ...
    FoodEntry("aubergine",     25.0,  1.0,   6.0,  0.2,  3.0, sugarsG = 3.2, aliases = listOf("eggplant")),
    ...
    FoodEntry("betterave",     43.0,  1.6,  10.0,  0.2,  2.8, sugarsG = 6.8, aliases = listOf("beetroot")),
    ...
    FoodEntry("poireau",       61.0,  1.5,  14.0,  0.3,  1.8, sugarsG = 3.9, aliases = listOf("poireaux", "leek")),
    FoodEntry("artichaut",     47.0,  3.3,  10.0,  0.2,  5.4, sugarsG = 1.0, magnesiumMg = 60.0, potassiumMg = 370.0, b9Ug = 68.0, aliases = listOf("artichoke")),
    FoodEntry("patate douce",  86.0,  1.6,  20.0,  0.1,  3.0, sugarsG = 4.2, vitAUg = 709.0, potassiumMg = 337.0, aliases = listOf("sweet potato")),
    FoodEntry("maïs",          86.0,  3.2,  19.0,  1.2,  2.7, sugarsG = 3.2, magnesiumMg = 37.0, potassiumMg = 270.0, aliases = listOf("mais", "corn", "sweetcorn")),
    FoodEntry("ail",          149.0,  6.4,  33.0,  0.5,  2.1, sugarsG = 1.0, aliases = listOf("garlic")),
    ...
    FoodEntry("fruit de la passion", 68.0, 1.1, 12.0, 0.7, 3.3, sugarsG = 11.2, aliases = listOf("passion fruit")),
    FoodEntry("litchi",        66.0,  0.8,  17.0,  0.4,  1.3, sugarsG = 15.2, aliases = listOf("litchis", "lychee")),
    FoodEntry("nectarine",     44.0,  1.1,  10.0,  0.3,  1.7, sugarsG = 8.4),
    ...
    FoodEntry("goyave",        68.0,  2.6,  14.0,  1.0,  5.4, sugarsG = 8.9, aliases = listOf("guava")),
    FoodEntry("papaye",        43.0,  0.5,  11.0,  0.3,  1.7, sugarsG = 7.8, aliases = listOf("papaya")),
    FoodEntry("fruit du dragon", 60.0, 1.2, 13.0,  0.4,  3.0, sugarsG = 7.7, aliases = listOf("pitaya", "dragon fruit")),

    // Légumes (extension)
    FoodEntry("fenouil",       31.0,  1.2,   7.3,  0.2,  3.1, sugarsG = 3.9, aliases = listOf("fennel")),
    FoodEntry("panais",        75.0,  1.2,  18.0,  0.3,  4.9, sugarsG = 4.8, aliases = listOf("parsnip")),
    FoodEntry("navet",         28.0,  0.9,   6.4,  0.1,  1.8, sugarsG = 3.8, aliases = listOf("turnip")),
    FoodEntry("endive",        17.0,  1.3,   3.2,  0.1,  3.1, sugarsG = 0.5, aliases = listOf("chicon")),
    ...
    FoodEntry("topinambour",   73.0,  2.0,  17.0,  0.0,  1.6, sugarsG = 9.6, aliases = listOf("jerusalem artichoke")),
)
